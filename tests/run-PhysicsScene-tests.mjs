 ...
 * Loads PhysicsScene.test.html and reports pass/fail results.
 */
...
const htmlPath = path.resolve(__dirname, 'PhysicsScene.test.html');
...
async function run() {
  ...
  console.log('\n=== PhysicsScene + CharmManager Test Results ===\n');
